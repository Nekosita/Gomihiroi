...
namespace UnityChan
{
	...
	public class CameraController : MonoBehaviour
	{
		...
		{
			Debug.Log("class CameraController:setupFocusObject()");
		...
		void Start ()
		{
			Debug.Log("class CameraController:Start()");
		...
		void OnGUI()
		{
			Debug.Log("class CameraController:OnGUI()");
			if (showInstWindow){
		...
		void mouseEvent()
		{
			Debug.Log("class CameraController:mouseEvent()");
		...
		{
			Debug.Log("class CameraController:mouseDragEvent()");
		...
		{
			Debug.Log("class CameraController:mouseWheelEvent()");
		...
		{
			Debug.Log("class CameraController:cameraTranslate()");
		...
		{
			Debug.Log("class CameraController:cameraRotate()");
